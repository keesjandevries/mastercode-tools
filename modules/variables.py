...
def mc_variables() :
    ...
    m={
            ...
            "R(D_ms)"      : MCV( b["RD_ms"],         index_offset=1,  offset_relative_to="PredictionIndex" ),
            ...
            "stau_r"       : MCV( b["stau_r"],        index_offset=12, offset_relative_to="SpectrumIndex" ),
            "stau_l"       : MCV( b["stau_l"],        index_offset=13, offset_relative_to="SpectrumIndex" ),
...
def base_variables() :
    return {
        ...
        "stau_r"       : Var( "stau_r",       r"$m_{\tilde{\tau}_{r}} %s$"%GeVc2 ),
        "stau_l"       : Var( "stau_l",       r"$m_{\tilde{\tau}_{l}} %s$"%GeVc2 ),
