...
class MCVariable() :
    def __init__( self, short_name, long_name, constraint_type = None, limit_value = 0, 
                  errors = [], offset_relative_to = None, index_offset = 0, 
        ...
        for attr in [ "short_name", "long_name", "constraint_type", 
                      "limit_value", "offset_relative_to", "index_offset",
                      "plot_range" ] :
    ...
    def getZValue(self, value) :
        return self.zvalue_function[self.constraint_type]( value )
