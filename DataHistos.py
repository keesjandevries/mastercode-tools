...
#        plot_vars = plots.get_plots(mcf)
        ...
        entry_hist_KOhack_s = histogram_processing.get_entry_hist_KOhack_list(mcf, spaces   )

        plot_modes = [ "pval", "chi2", "dchi" ]
#        histogram_processing.fill_and_save_data_hists( mcf, plot_modes,
#                                                       plot_hist_KOhack_s,
#                                                       contrib_vars, predict_vars)
        histogram_processing.fill_and_save_data_hists( mcf, spaces,entry_hist_KOhack_s,
